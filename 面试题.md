...
![image-20200218112027313](C:\Users\chen\AppData\Roaming\Typora\typora-user-images\image-20200218112027313.png)
...
为什么要使用apply？为了保证sayHi执行时的this指向input；
...
**for of**：可以循环很多数据结构；可以循环终止：break，continue；还可以循环遍历器；
